...
export const products = [
  ...
  {
    id: 28,
    name: "Embellished Lace Up High Heel",
    price: 1500,
  ...
  {
    id: 29,
    name: " Ready to Wear Casual Shirt",
    price: 400,
  ...
  {
    id: 33,
    name: "Pure cotton Kurta & Dhoti Set",
    price: 1500,
